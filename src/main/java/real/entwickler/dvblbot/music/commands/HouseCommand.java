...
public class HouseCommand extends ICommand {
    ...
    public void onCommand(Member commandSender, TextChannel textChannel, Message message, String[] args) {
        ...
        if (args.length == 1) {
            Bot.getInstance().getMusicController().loadPlaylist("https://www.youtube.com/watch?v=e7HBypw4lhY&list=PL2kkyPD7bvonKx8cE9T_oY3-hrhzEMMVO", commandSender, message, playlist -> {
